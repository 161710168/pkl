			  	...
			  	<form action="{{ route('kelas.update',$kls->id) }}" method="post" >
        			...
        			{{ csrf_field() }}
			  		<div class="form-group {{ $errors->has('kelas') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="kelas" class="form-control" value="{{ $kls->kelas }}"  required>
			  			@if ($errors->has('kelas'))
			  		...
			  		<div class="form-group {{ $errors->has('tahun_ajaran') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="tahun_ajaran" class="form-control" value="{{ $kls->tahun_ajaran }}"  required>
