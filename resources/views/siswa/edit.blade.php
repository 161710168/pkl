		...
		<div class="col-md-12">
			<div class="panel">
			  ...
			  <div class="panel-body">
			  	<form action="{{ route('siswa.update',$n->id) }}" method="post" >
        			...
        			{{ csrf_field() }}
			  		...
			  		<div class="form-group {{ $errors->has('ttl') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="ttl" class="form-control" value="{{ $n->ttl }}"  required>
			  			@if ($errors->has('ttl'))
                            <span class="help-block">
			  		...
			  		<div class="form-group {{ $errors->has('alamat') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="alamat" class="form-control" value="{{ $n->alamat }}"  required>
